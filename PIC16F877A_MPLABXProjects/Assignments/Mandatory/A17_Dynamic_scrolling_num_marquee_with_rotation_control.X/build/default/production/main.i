...
void main(void)
{
    ...
    unsigned short edit_mode_flag = 1;
    unsigned short pause_flag = 0;
    unsigned short first_iter_flag = 1;
    ...
    while (1)
    {
        ...
        if (edit_mode_flag == 1)
        {
            ...
            {
                case 0:
                    clcd_putch((unsigned char) 0xFF, (0xC0 + pos));
                    break;
                case 1:
                    clcd_print(msg, (0xC0 + 4));
                    break;
            }
            ...
            else if (key == 6)
            {
                if (pos > 4 && pos < 16)
                {
                    clcd_putch(' ', (unsigned char) (0xC0 + pos));
                    msg[index] = ' ';
