...
unsigned int compare(char *str1, char *str2)
{
    unsigned int flag;
...
void main(void)
{
    ...
    char original_password[] = "10101010";
    ...
    while (1)
    {
        if (attempt != 0)
        {
            ...
            {
                match = compare(original_password, entered_password);

                if (match == 1)
                {
                    clcd_print("EXCELLENT, YOU ", (0x80 + 0));
                ...
                else
                {
                    while (wait++ != 10)
                    {
                        ...
                        clcd_putch((unsigned char) (attempt - 1) + '0', (0xC0 + 0));
                        clcd_print(" ATTEMPTS LEFT ", (0xC0 + 1));
                    }
        ...
        {
            clcd_print("  PLEASE RESET  ", (0x80 + 0));
            clcd_print("   THE BOARD    ", (0xC0 + 0));
        }
    }
