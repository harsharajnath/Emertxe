...
static void init_config(void)
{
    ...
    init_digital_keypad();
    init_i2c(100000);
    count = (eeprom_at24c04_random_read(0x01) * 100) + eeprom_at24c04_random_read(0x00);
}
...
void main(void)
{
    ...
    while (1)
    {
        key_inc = read_digital_keypad(1);
        key_lp = read_digital_keypad(0);
        ...
        if (key_inc == 0x3D)
        {
            eeprom_at24c04_byte_write(0x00, (count % 100));
            eeprom_at24c04_byte_write(0x01, (unsigned char) (count / 100));
        }
