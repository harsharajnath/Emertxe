...
void main(void)
{
    ...
    char msg[] = "CLCD Test Code  ";

    init_config();

    clcd_print("Select MKP SW", (0x80 + 0));
    clcd_print("S1-Left S2-Right", (0xC0 + 0));
    ...
    while (1)
    {
        ...
        if (key_copy == 1)
        {
            clcd_print("Left Scrolling ", (0x80 + 0));
        ...
        {
            clcd_print("Right Scrolling ", (0x80 + 0));
