...
static void init_config(void)
{
    ...
    init_i2c(100000);
    count = (eeprom_ext_read(0x01) * 100) + eeprom_ext_read(0x00); /* restoring saved data into count */
}
...
void main(void)
{
    ...
    while (1) /*super loop */
    {
        ...
        {
            eeprom_ext_write(0x00, (count % 100)); /* writing LSBs to 0x00 */
            eeprom_ext_write(0x01, (unsigned char) (count / 100)); /* writing MSBs to 0x01 */
        }
